...
module.exports = {
    VERSION: 'v3.0.0',
    ALIVE: process.env.ALIVE || "https://i.imgur.com/8RkWxdB.jpg Hey {sender}, I'm alive \n Uptime: {uptime}",
    ...
    CHATBOT: process.env.CHATBOT || 'one',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA||"nore_freezer",
    BOT_NAME: process.env.BOT_NAME || 'nore_freezer',
